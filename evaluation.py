...
def evaluate_fn(ModelClass, config, nlp, dataloader, num_batches=1):
    def evaluate(checkpoint):
        ...
        similarity_threshold1 = 0.53
        correct1 = 0
        false_similarity1 = 0
        true_similarity1 = 0
        similarity_threshold2 = 0.61
        correct2 = 0
        false_similarity2 = 0
        true_similarity2 = 0
        similarity_threshold3 = 0.73
        correct3 = 0
        false_similarity3 = 0
        true_similarity3 = 0
        ...
        print(f'[EVALUATE] perpendicular|proportional:\t{(error1 + error2):0.5f}')
...
if __name__ == '__main__':
    ...
    checkpoint1 = 'tmp/checkpoints/v10/epoch17_encoder1'
    checkpoint2 = 'tmp/checkpoints/v10/epoch17_encoder2'
